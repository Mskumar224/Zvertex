...
router.post('/subscribe', async (req, res) => {
  ...
  console.log('Received Subscription Request:', { paymentMethodId, plan });
  ...
  try {
    ...
    const planPriceMap = {
      STUDENT: 'price_xxxxxxxxxxxxxx', // Replace with actual Price ID
    ...
    res.status(400).json({ error: error.message || 'An error occurred with our connection to Stripe' });
  }
});
