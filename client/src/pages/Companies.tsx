      ...
      <form onSubmit={handleSubmit}>
        <FormControl fullWidth margin="normal">
          ...
          >
            {predefinedCompanies.map((company) => (
              <MenuItem
                key={company}
                value={company}
                disabled={selectedCompanies.length >= 10 && !selectedCompanies.includes(company)}
              >
                {company}
              </MenuItem>
            ))}
          ...
          <Typography variant="caption" color="textSecondary">
            Selected: {selectedCompanies.length}/10
          </Typography>
        </FormControl>
        <TextField
        ...
        <Button
          ...
          disabled={!manualCompany || selectedCompanies.length >= 10}
          sx={{ mt: 1, mb: 2 }}
        >
          Add
        </Button>
