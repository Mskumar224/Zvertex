    ...
    <Container sx={{ py: 8, textAlign: 'center', background: 'linear-gradient(135deg, #e3f2fd, #bbdefb)', minHeight: '100vh' }}>
      ...
      <Box sx={{ mb: 5 }}>
        ...
        <Typography variant="h6" sx={{ maxWidth: 600, mx: 'auto', color: '#424242' }}>
          Unlock your career potential with ZvertexAI – the ultimate AI-powered job application platform. Upload your resume, choose a tailored subscription, and let us auto-apply to top-tier opportunities while you focus on what matters most.
        </Typography>
      </Box>
