  ...
  return (
    <Container maxWidth="lg" sx={{ py: 6 }}>
      ...
      <Grid container spacing={4}>
        {[
          { title: 'For Students', desc: 'Kickstart your career with auto-applied jobs', path: '/student-dashboard' },
          { title: 'For Recruiters', desc: 'Manage 5 profiles with ease', path: '/recruiter-dashboard' },
          { title: 'For Businesses', desc: 'Scale hiring with 3 recruiters', path: '/business-dashboard' },
        ].map((item) => (
