        ...
        <Box sx={{ py: 2 }}>
          ...
          <Box sx={{ maxWidth: '800px', mx: 'auto', mb: 6 }}>
            ...
            <Typography variant="body1" sx={{ mb: 4 }}>
              Our DevOps Integration project streamlines software development and deployment with tools like Docker, Kubernetes, and CI/CD pipelines. We ensure faster releases, higher quality, and robust systems for all our AI-driven solutions.
            </Typography>
            <Typography variant="h5" sx={{ mb: 2, fontWeight: 'bold' }}>
              Why Join Us?
            </Typography>
            <Typography variant="body1" sx={{ mb: 2 }}>
              - <strong>For Clients:</strong> Deploy reliable, scalable applications with our DevOps expertise.
            </Typography>
            <Typography variant="body1" sx={{ mb: 2 }}>
              - <strong>For Users:</strong> Master DevOps tools and practices while contributing to our ecosystem.
            </Typography>
            <Typography variant="body1" sx={{ mb: 4 }}>
              Join us to build the backbone of modern software delivery.
            </Typography>
