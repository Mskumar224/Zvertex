        ...
        <Grid container spacing={4}>
          <Grid item xs={12}>
            ...
            <Typography variant="body1" sx={{ mb: 2 }}>
              Join our Cloud project to migrate legacy systems to AWS, Azure, or GCP. Work with tools like
              Terraform, Kubernetes, and Docker to build scalable, secure infrastructure.
            </Typography>
            <Typography variant="body1" sx={{ mb: 2 }}>
              <strong>Technologies:</strong> AWS, Azure, GCP, Terraform, Kubernetes, Docker, Ansible
            </Typography>
            <Typography variant="body1" sx={{ mb: 2 }}>
              <strong>Skills Gained:</strong> Cloud architecture, infrastructure as code, containerization,
              automation
            </Typography>
          </Grid>
            ...
            <Card sx={{ backgroundColor: '#1e1e1e', color: 'white', borderRadius: '15px' }}>
              <CardContent>
                ...
                <Typography variant="body2">
                  - Master cloud platforms used by top companies<br />
                  - Learn DevOps best practices<br />
                  - Enhance your resume with in-demand skills
                </Typography>
              </CardContent>
            </Card>
          </Grid>
