    ...
    <Box sx={{ minHeight: '100vh', background: 'linear-gradient(135deg, #1a2a44 0%, #2e4b7a 100%)', color: 'white' }}>
      <Container maxWidth="lg">
        ...
        <Typography variant="h6" sx={{ mb: 4, textAlign: 'center', opacity: 0.9 }}>
          Seamlessly transition enterprises to the cloud with optimized architectures.
        </Typography>
            ...
            <Card sx={{ backgroundColor: 'rgba(255,255,255,0.1)', color: 'white', borderRadius: '15px' }}>
              <CardContent>
                ...
                <Typography variant="body2" sx={{ mt: 1 }}>
                  Our cloud migration project helps businesses move legacy systems to AWS, Azure, or GCP, reducing costs by 30% and improving scalability.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
          <Grid item xs={12} sm={6}>
            <Card sx={{ backgroundColor: 'rgba(255,255,255,0.1)', color: 'white', borderRadius: '15px', height: '100%' }}>
              <CardContent>
                ...
                <Typography variant="body2" sx={{ mt: 1 }}>
                  Achieve faster deployment and enhanced security with our tailored cloud migration strategies.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
          <Grid item xs={12} sm={6}>
            <Card sx={{ backgroundColor: 'rgba(255,255,255,0.1)', color: 'white', borderRadius: '15px', height: '100%' }}>
              <CardContent>
                ...
                <Typography variant="body2" sx={{ mt: 1 }}>
                  Work on real-world cloud projects, mastering tools like Docker, Kubernetes, and Terraform.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
