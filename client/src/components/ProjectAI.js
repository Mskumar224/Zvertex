        ...
        <Box sx={{ py: 2 }}>
          ...
          <Box sx={{ maxWidth: '800px', mx: 'auto', mb: 6 }}>
            ...
            <Typography variant="body1" sx={{ mb: 4 }}>
              Our AI Automation project focuses on building intelligent systems that automate complex workflows, from job applications to data processing. Picture an AI that handles repetitive tasks, freeing you to focus on creativity and strategy.
            </Typography>
            <Typography variant="h5" sx={{ mb: 2, fontWeight: 'bold' }}>
              Why Join Us?
            </Typography>
            <Typography variant="body1" sx={{ mb: 2 }}>
              - <strong>For Clients:</strong> Automate your business processes with AI, improving efficiency and reducing costs.
            </Typography>
            <Typography variant="body1" sx={{ mb: 2 }}>
              - <strong>For Users:</strong> Work on groundbreaking AI models and gain expertise in automation technologies.
            </Typography>
            <Typography variant="body1" sx={{ mb: 4 }}>
              Join us to harness AI’s potential and transform the way we work.
            </Typography>
