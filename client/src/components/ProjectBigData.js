    ...
    <Box sx={{ minHeight: '100vh', background: 'linear-gradient(135deg, #1a2a44 0%, #2e4b7a 100%)', color: 'white' }}>
      <Container maxWidth="lg">
        ...
        <Typography variant="h6" sx={{ mb: 4, textAlign: 'center', opacity: 0.9 }}>
          Unlock insights from massive datasets with advanced analytics.
        </Typography>
            ...
            <Card sx={{ backgroundColor: 'rgba(255,255,255,0.1)', color: 'white', borderRadius: '15px' }}>
              <CardContent>
                ...
                <Typography variant="body2" sx={{ mt: 1 }}>
                  Our big data platform processes petabytes of retail data, delivering real-time insights that increase sales by 20%.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
          <Grid item xs={12} sm={6}>
            <Card sx={{ backgroundColor: 'rgba(255,255,255,0.1)', color: 'white', borderRadius: '15px', height: '100%' }}>
              <CardContent>
                ...
                <Typography variant="body2" sx={{ mt: 1 }}>
                  Make data-driven decisions with our analytics tools, optimized for speed and accuracy.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
          <Grid item xs={12} sm={6}>
            <Card sx={{ backgroundColor: 'rgba(255,255,255,0.1)', color: 'white', borderRadius: '15px', height: '100%' }}>
              <CardContent>
                ...
                <Typography variant="body2" sx={{ mt: 1 }}>
                  Learn Hadoop, Spark, and data visualization while building impactful analytics solutions.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
