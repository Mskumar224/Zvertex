        ...
        <Grid container spacing={4}>
          <Grid item xs={12}>
            ...
            <Typography variant="body1" sx={{ mb: 2 }}>
              Join our Big Data project to analyze massive datasets using Hadoop, Spark, and Kafka. Build
              real-time analytics platforms for industries like finance and healthcare.
            </Typography>
            <Typography variant="body1" sx={{ mb: 2 }}>
              <strong>Technologies:</strong> Hadoop, Spark, Kafka, Hive, Cassandra, Elasticsearch
            </Typography>
            <Typography variant="body1" sx={{ mb: 2 }}>
              <strong>Skills Gained:</strong> Data processing, distributed computing, real-time analytics
            </Typography>
          </Grid>
            ...
            <Card sx={{ backgroundColor: '#1e1e1e', color: 'white', borderRadius: '15px' }}>
              <CardContent>
                ...
                <Typography variant="body2">
                  - Work with enterprise-grade data tools<br />
                  - Learn to handle petabytes of data<br />
                  - Prepare for high-demand data roles
                </Typography>
              </CardContent>
            </Card>
          </Grid>
