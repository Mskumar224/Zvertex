      ...
      <Container maxWidth="lg">
        <Box sx={{ textAlign: 'center', mb: 6 }}>
          ...
          <Typography variant="body1" sx={{ color: 'white', mb: 4, maxWidth: '600px', mx: 'auto' }}>
            Analyze large datasets to uncover trends and optimize job matching algorithms.
          </Typography>
        </Box>
          ...
          <Grid item xs={12} sm={6}>
            <Box sx={{ backgroundColor: 'rgba(255,255,255,0.1)', p: 3, borderRadius: '15px' }}>
              ...
              <Typography variant="body2" sx={{ color: 'white' }}>
                Build pipelines for processing job market data and generating analytics.
              </Typography>
            </Box>
          </Grid>
          <Grid item xs={12} sm={6}>
