      ...
      <Container maxWidth="lg">
        <Box sx={{ mt: 8, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <Typography variant="body1" sx={{ mb: 4, maxWidth: '800px', textAlign: 'center' }}>
            Join our AI projects to build cutting-edge machine learning models, NLP solutions, and computer vision applications with tools like TensorFlow and PyTorch.
          </Typography>
          <Button
            variant="contained"
            sx={{
