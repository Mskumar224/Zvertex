        ...
        <Box sx={{ py: 2 }}>
          ...
          <Box sx={{ maxWidth: '800px', mx: 'auto', mb: 6 }}>
            ...
            <Typography variant="body1" sx={{ mb: 4 }}>
              Our SaaS Solutions project develops AI-driven tools to streamline job applications, enhance productivity, and automate repetitive tasks. Imagine a platform that crafts tailored resumes and applies to jobs on your behalf—saving you time and boosting your chances of success.
            </Typography>
            <Typography variant="h5" sx={{ mb: 2, fontWeight: 'bold' }}>
              Why Join Us?
            </Typography>
            <Typography variant="body1" sx={{ mb: 2 }}>
              - <strong>For Clients:</strong> Access scalable, subscription-based tools that transform how you manage your career or hire talent.
            </Typography>
            <Typography variant="body1" sx={{ mb: 2 }}>
              - <strong>For Users:</strong> Contribute to building innovative SaaS products and gain hands-on experience with AI and software development.
            </Typography>
            <Typography variant="body1" sx={{ mb: 4 }}>
              Join us to be part of a project that’s redefining the SaaS landscape with AI-powered efficiency.
            </Typography>
