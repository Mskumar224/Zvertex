      ...
      <Container maxWidth="lg">
        <Box sx={{ mt: 8, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <Typography variant="body1" sx={{ mb: 4, maxWidth: '800px', textAlign: 'center' }}>
            Our SaaS projects deliver scalable, user-friendly software solutions tailored to modern business needs. Join our team to build innovative platforms that drive efficiency and growth.
          </Typography>
          <Button
            variant="contained"
            sx={{
