      ...
      <Container maxWidth="lg">
        <Box sx={{ mt: 8, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <Typography variant="body1" sx={{ mb: 4, maxWidth: '800px', textAlign: 'center' }}>
            Our DevOps projects streamline development and operations with CI/CD pipelines and automation tools like Docker and Kubernetes. Join us to optimize workflows.
          </Typography>
          <Button
            variant="contained"
            sx={{
