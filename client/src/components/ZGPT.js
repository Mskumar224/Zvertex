...
import { Box, Typography, TextField, Button, Container, CircularProgress, IconButton, FormControl, InputLabel, Select, MenuItem } from '@mui/material';
    ...
    <Box sx={{ minHeight: '100vh', background: 'linear-gradient(135deg, #1a2a44 0%, #2e4b7a 100%)', py: 4 }}>
      <Container maxWidth="lg">
        ...
        <Typography variant="body1" sx={{ color: 'white', mb: 4 }}>
          Powered by Zoho Prompt Engineering and Llama 3.1. Ask in English or Telugu.
        </Typography>
