            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                <FormControl fullWidth>
                  ...
                  >
                    <MenuItem value="STUDENT">Student (4-day free trial)</MenuItem>
                    <MenuItem value="RECRUITER">Recruiter (4-day free trial)</MenuItem>
                    <MenuItem value="BUSINESS">Business (4-day free trial)</MenuItem>
                  </Select>
                </FormControl>
              </Grid>
              <Grid item xs={12}>
