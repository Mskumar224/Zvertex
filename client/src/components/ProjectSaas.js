    ...
    <Box sx={{ minHeight: '100vh', backgroundColor: '#121212', color: 'white', py: 4 }}>
      <Container maxWidth="lg">
        ...
        <Typography variant="h4" sx={{ mb: 4, textAlign: 'center', fontWeight: 'bold' }}>
          SaaS Solutions Project
        </Typography>
        <Grid container spacing={4}>
          <Grid item xs={12}>
            <Typography variant="h6" sx={{ mb: 2 }}>
              Build Scalable Software-as-a-Service Applications
            </Typography>
            <Typography variant="body1" sx={{ mb: 2 }}>
              Join our SaaS project to develop cloud-native applications using modern frameworks like React,
              Node.js, and AWS. Collaborate with experts to create subscription-based services for global
              businesses.
            </Typography>
            <Typography variant="body1" sx={{ mb: 2 }}>
              <strong>Technologies:</strong> React, Node.js, Express, MongoDB, AWS, Docker, Stripe
            </Typography>
            <Typography variant="body1" sx={{ mb: 2 }}>
              <strong>Skills Gained:</strong> Full-stack development, microservices, payment integration, CI/CD
            </Typography>
          </Grid>
            ...
            <Card sx={{ backgroundColor: '#1e1e1e', color: 'white', borderRadius: '15px' }}>
              <CardContent>
                ...
                <Typography variant="body2">
                  - Work on real-world SaaS products<br />
                  - Gain experience with cutting-edge tools<br />
                  - Boost your portfolio for top tech roles
                </Typography>
              </CardContent>
            </Card>
          </Grid>
